...
class Fragment0: Fragment(R.layout.fragment_number_list){
    ...
    private fun initList(){
        ...
        departmentList.add(NumberModel("국제지원팀","032-860-7035","0328607035","7-505호"))
        departmentList.add(NumberModel("국제지원팀","032-860-7036","0328607036","7-505호"))
        departmentList.add(NumberModel("국제지원팀","032-860-7037","0328607037","7-505호"))
        departmentList.add(NumberModel("국제지원팀","032-860-7038","0328607038","7-505호"))
        departmentList.add(NumberModel("국제지원팀","032-860-7039","0328607039","7-505호"))
